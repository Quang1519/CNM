...
<h2 class="section-title wow fadeInUp" data-wow-delay="0.2s">Khách mời</h2>
<p class="wow fadeInDown" data-wow-delay="0.2s">Với sự góp mặt của các nghệ sĩ nổi tiếng cùng với những cựu sinh viên của trường <br> Danh sách những khách mời.</p>
</div>
</div>
</div>
...
<div class="col-12">
<div class="section-title-header text-center">
<h2 class="section-title wow fadeInUp" data-wow-delay="0.2s">Hình ảnh sự kiện </h2>
<p class="wow fadeInDown" data-wow-delay="0.2s">Sự kiện hằng năm luôn thu hút đông đảo sinh viên cùng những khách mời nổi tiếng tham gia<br> Một số hình ảnh tiêu biểu.</p>
</div>
</div>
</div>
<div class="row">
...
<div class="col-12">
<div class="section-title-header text-center">
<h2 class="section-title wow fadeInUp" data-wow-delay="0.2s">Sự kiện đang chờ đón bạn </h2>
<p class="wow fadeInDown" data-wow-delay="0.2s">Đừng bỏ lỡ cơ hội tham dự buổi lễ khai giảng sôi dộng, nhiệt huyết này<br> Hẹn gặp lại bạn vào ngày sự kiện diễn ra.</p>
</div>
</div>
</div>
<div class="row">
